...
movies = [toy_story, avatar, the_social_network, i_am_legend, life_of_pi, catch_me_if_you_can] # Adds all movie's too the movie array

fresh_tomatoes.open_movies_page(movies)	# Passes the movies array too the open_movies_page() function
